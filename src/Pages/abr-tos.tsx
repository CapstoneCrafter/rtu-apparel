  ...
  return(
    <div className='max-w-7xl mx-auto'>
        <div className='mx-5 my-5'>
            ...
            <h1 className='text-sm font-bold'>Thank you for choosing <span className='text-orange-500 font-bold'>RTU Apparel!</span> | © 2023 RTU Apparel. All Rights Reserved.</h1>
            </div>
        </div>
