  ...
  return (
    <div className='max-w-7xl mx-auto'>
        <div className='my-8 mx-5 lg:flex items-center lg:my-32 '>
            ...
            <p className='text-gray-500 text-md mt-2'> If you cannot find what you are looking for, feel free to contact us through our website's <a href='#' className='font-bold text-orange-500 hover:text-indigo-500'>contact us</a> page.</p>
            </div>
            ...
            <p className='mb-4 text-justify  text-gray-500text-sm'>We accept Gcash and Cash on Delivery as forms of payment.</p>
