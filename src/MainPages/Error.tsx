...
export const Error = () => {
  return (
    ...
    <div className="mx-auto max-w-7xl h-screen flex justify-center items-center ">
        ...
        <a href="#" className="rounded-md bg-black px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-orange-500 focus-visible:outline ">Go back home <span aria-hidden="true">→</span></a>
        </div>
